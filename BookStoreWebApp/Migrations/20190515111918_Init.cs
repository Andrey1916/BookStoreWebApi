        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrgPrice = table.Column<decimal>(type: "decimal(10,3)", nullable: false),
                    ActualPrice = table.Column<decimal>(type: "decimal(10,3)", nullable: false),
                    PromotionalText = table.Column<string>(maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    VoterName = table.Column<string>(maxLength: 50, nullable: true),
                    NumStars = table.Column<long>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumBooks = table.Column<long>(nullable: false),
                    BookPrice = table.Column<decimal>(type: "decimal(10,3)", nullable: false),
